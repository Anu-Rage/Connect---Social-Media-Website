...
import { createCommentReels } from '../../Redux/Comment/comment.action';
import { getAllReels, likeReels, savePost } from '../../Redux/Reels/reels.acton';
import { pink } from '@mui/material/colors';


const ReelsCard = ({reel, video}) => {
...
dispatch(likeReels(reel?.id))
  ...
  return (
    ...
    <Card>
      ...
      />
        <div className="w-[25rem] h-[40rem] p-2">
        {video.endsWith('.mp4') ? (
          <video className="w-screen h-screen rounded-md" controls>
            <source src={video} type="video/mp4" />
          </video>
        ) : (
          <img className="w-screen h-screen" src={video} alt="Reel" />
        )}
      </div>
      <CardContent>
